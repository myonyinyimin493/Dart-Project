...
class viewfunction extends StatelessWidget {
  final snap;
  viewfunction({Key? key, required this.snap}) : super(key: key);
                ...
                Padding(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                        ...
                        firestore.collection("Booking").add(data).then((value) => showAlertDialog(context));
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text("Your Appointment has been successfully added."),
      actions: [
        okButton,
      ],
    );
